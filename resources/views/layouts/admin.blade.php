                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="@yield('createuser')" >
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('admin.users') }}"><i class="zmdi zmdi-dot-circle-alt"></i>All Users</a></li>
                            <li><a href="{{ route('admin.create') }}"><i class="zmdi zmdi-dot-circle-alt"></i>Create User</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javaScript:void();" class="waves-effect">
                        <i class="zmdi zmdi-widgets"></i> <span>Transactions</span>
                        <i class="fa fa-angle-left float-right"></i>
                        </a>
                        <ul class="sidebar-submenu">
                        <li><a href="{{ route('admin.credits') }}"><i class="zmdi zmdi-dot-circle-alt"></i>Credits</a></li>
                        <li><a href="{{ route('admin.debits') }}"><i class="zmdi zmdi-dot-circle-alt"></i>Debits</a></li>
                        </ul>
                    </li>
                    <li>
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                    ...
                    <li class="dropdown-item user-details">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                            <h6 class="mt-2 user-title">{{$profile->surname}}</h6>
                            <p class="user-subtitle">{{$profile->phone_number}}</p>
                            </div>
                        </div>
                        </a>
                        </li>
                ...
                $("#transferForm").validate({
                    ...
                    messages: {
                        amount: {
                            ...
                            minlength: "Your amount must consist of at least 2 digits"
                        },
                    }
                });
            });
