            ...
            <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        ...
                        <li><a href="{{ route('user.credits') }}"><i class="zmdi zmdi-dot-circle-alt"></i>Credits</a></li>
                        <li><a href="{{ route('user.debits') }}"><i class="zmdi zmdi-dot-circle-alt"></i>Debits</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="{{route('user.transfer')}}" class="waves-effect">
