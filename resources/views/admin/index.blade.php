                    ...
                    <section class="scrollable padder">
                        ...
                        <div class="row">
                                    ...
                                    <div class="row m-n">
                                        <div class="col-md-12 b-b b-r">
                                            <a href="#" class="block padder-v hover">
                                                ...
                                                <span class="clear">
                                                    <span class="h3 block m-t-xs text-info">{{$users}}
                                        ...
                                        <div class="col-md-6 b-b b-r">
                                            <a href="#" class="block padder-v hover">
                                                ...
                                                <span class="clear">
                                                    <span class="h3 block m-t-xs text-danger">{{$disabledAccounts}}</span>
                                                    <small class="text-muted text-u-c">Disabled Accounts</small>
                                                </span>
                                            </a>
                                        </div>
                                        <div class="col-md-6 b-b">
                                            <a href="#" class="block padder-v hover">
                                                ...
                                                <span class="clear">
                                                    <span class="h3 block m-t-xs text-success">{{$activeAccounts}}</span>
                                                    <small class="text-muted text-u-c">Active Accounts</small>
                                                </span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="panel-heading no-border bg-info lter text-center">
                                    <a href="#">
                                    <i class="fa  fa-exchange fa fa-3x m-t m-b text-white"></i>
                                    </a>
                                </div>
                                <div class="padder-v text-center clearfix">
                                    <div class="col-xs-6 b-r">
                                    <div class="h4 font-bold">27k</div>
                                    <small class="text-muted">Total Deposits</small>
                                    </div>
                                    <div class="col-xs-6">
                                    <div class="h4 font-bold">3000000</div>
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                <div class="text-xs">
                                    <i class="fa fa-circle text-info"></i>Active Accounts
                                    <i class="fa fa-circle text-muted"></i>Disabled Accounts
                                </div>
                                <div class="line pull-in"></div>
                                <div class="sparkline inline" data-type="pie" data-height="154" data-slice-colors="['#1ccacc','#f2f2f2']">{{$activeAccounts}}, {{360-$activeAccounts}}</div>
