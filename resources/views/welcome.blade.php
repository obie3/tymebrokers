                    ...
                    <div>
                        ...
                        <section>
                            <div class="form-group">
                                ...
                                <input class="required form-control" id="userName2" name="user_name" value="{{old('user_name')}}" type="text">
                            </div>
                            <div class="form-group">
                        ...
                        <section>
                            <div class="form-group">
                                <label for="account_title">Account Title*</label>
                                    <input id="account" name="account_name" type="text" value="{{old('account_name')}}" class="required form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="swift" name="routing_number" type="text" value="{{old('routing_number')}}" class="required routing form-control">
                            </div>
                            <div class="form-group">
                                <label class="col-lg-12 control-label">(*) Mandatory</label>
                            </div>
